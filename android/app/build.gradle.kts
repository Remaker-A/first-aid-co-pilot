...
android {
    namespace = "com.firstaid.copilot"
    compileSdk = 35
...
dependencies {
    ...
    // Live CPR Coach foundation: agent transport, coroutines, lifecycle, camera.
    // All Live-phase build wiring lives here so later phases only add Kotlin files.
