...
const ACCEPTANCE_STEPS = [
  ...
  },
  {
    ...
    spokenText: "开始按压",
    idealAnswer: "现在开始胸外按压，跟着震动快速有力地按。",
    payload: {
  ...
  },
  {
    ...
    spokenText: "除颤仪来了怎么办",
    idealAnswer: "继续按压。让旁边的人打开 AED，按设备语音提示贴电极。",
    advanceMs: 1500,
    payload: {},
    expect: {
      stage: "S7_CPR_LOOP",
  ...
  },
  {
    ...
    spokenText: "",
    idealAnswer: "有人取到 AED 时，你继续按压，听设备提示。",
    advanceMs: 16000,
    payload: {
      eventSource: "vision_patient",
      eventType: "patient_state_update",
